...
export default function Box2({ image, title, logo}) {
  return (
    <div className='w-[640px] mx-[2px] pointemb-[4px] h-[350px] bg-white relative hover:cursor-pointer'>
        ...
        <div className='w-[640px] opacity-80 h-[200px] absolute  bottom-0 bg-gradient-to-b from-transparent to-black' ></div>
