...
export default function SignUP() {
  return (
    <div className='bg-red-600 w-full h-[350px] relative'>
        <div className='w-full h-full flex font-Roboto absolute z-10 px-[300px]'>
            <img  className='pr-10' src="https://images.ctfassets.net/swt2dsco9mfe/6Kea8mPfG9Ba1RLniuJGlo/b6c63cfc2dfb1b4106e7d45f7754bb8a/D7h01oScW0cn-productth-lorecard.png?w=406&h=312&q=70&fit=thumb&fm=avif" alt="/" />
            <div className='flex flex-col justify-center items-start pl-10'>
                <h1 className='text-red-800 font-extrabold text-4xl pb-10'>Get Digital D&D Content</h1>
