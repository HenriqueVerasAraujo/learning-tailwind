...
export default function Header() {
  return (
    <div className='w-full h-[60px] z-10 bg-[#dfddd6] px-3 fixed border-b-4 border-red-700 shadow-xl'>
			<div className='md:w-full md:h-full flex md:items-center justify-center md:justify-between md:px-3 xl:px-[20%]'>
				...
				<div className='hidden md:flex justify-between'>
					...
					<h2 className='px-4 text-1xl hover:text-red-700 text-zinc-700 font-bold'>EVENTS</h2>
				</div>
